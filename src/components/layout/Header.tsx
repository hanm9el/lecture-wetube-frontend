                            ...
                            <div className={"relative"}>
                                ...
                                {isMenuOpen && (
                                    ...
                                    >
                                        ...
                                        >
                                            <p className={twMerge(["font-semibold"])}>{user.nickname}</p>
                                        ...
                                        <div className={twMerge(["py-2"])}>
                                            ...
                                            >
                                                <MdAccountBox className={twMerge(["w-5", "h-5"])} />내 채널
                                            </Link>
                                            <Link
                                                to={"/inquiries"}
                                                onClick={() => setIsMenuOpen(false)}
                                            ...
                                            >
                                                <MdSupportAgent className={twMerge(["w-5", "h-5"])} />
                                                고객센터 (1:1 문의)
                                            </Link>
                                        </div>
                                        ...
                                        <button
                                            ...
                                            className={twMerge(
                                                ...
                                                ["text-error-main", "text-sm", "hover:bg-error-main/5"],
                                            )}
                                        >
                                            <MdLogout className={twMerge(["w-5", "h-5"])} /> 로그아웃
                                        </button>
                                    </div>
                                )}
                            </div>
