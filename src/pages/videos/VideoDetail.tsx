    ...
    return (
        ...
        >
            ...
            <div className={twMerge(["flex-1"])}>
                {/*비디오 플레이어*/}
                <div className={twMerge(["w-full", "aspect-video", "rounded-xl", "overflow-hidden"])}>
                    {/*video tag
                ...
                <div className={twMerge(["mt-4", "pb-4", "border-b", "border-divider"])}>
                    ...
                    <div className={twMerge(["flex", "items-center", "justify-between"])}>
                        <div className={twMerge(["flex", "items-center", "gap-3"])}>
                            <Avatar nickname={video.author.nickname} src={video.author.profileImage} />
                        ...
                        <div className={twMerge(["flex", "gap-2"])}>
                            ...
                            >
                                ...
                                <span className={twMerge(["text-sm", "font-medium"])}>{likeCount}</span>
                            </button>
                            <button
                                className={twMerge(
                                    ["flex", "items-center", "gap-2"],
